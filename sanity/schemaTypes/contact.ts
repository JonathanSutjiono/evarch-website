...
export const contact = defineType({
  ...
  fieldsets: [
    { name: "content", title: "Konten Utama Section Contact", options: { collapsible: true } },
    { name: "contact", title: "Tombol dan Informasi Kontak", options: { collapsible: true } },
    { name: "map", title: "Lokasi, Peta, dan Link Google Maps", options: { collapsible: true, collapsed: true } },
    { name: "social", title: "Media Sosial (opsional)", options: { collapsible: true, collapsed: true } },
  ],
  fields: [
    defineField({ name: "heading", title: "Judul kontak", description: "Tampil sebagai judul besar pada section Contact di akhir halaman utama. Gunakan ajakan konsultasi yang jelas dan singkat, lalu klik Publish.", type: "string", fieldset: "content" }),
    defineField({ name: "description", title: "Deskripsi kontak", description: "Tampil di bawah judul Contact. Jelaskan singkat hal yang dapat didiskusikan calon klien, idealnya 1-2 kalimat, lalu klik Publish.", type: "text", rows: 4, fieldset: "content" }),
    defineField({ name: "whatsappNumber", title: "Nomor WhatsApp", description: "Digunakan untuk tombol konsultasi pada section Contact. Gunakan kode negara tanpa tanda +, contoh: 6281234567890. Jika kosong, website memakai nomor WhatsApp utama dari Pengaturan Website. Klik Publish setelah mengubahnya.", type: "string", fieldset: "contact" }),
    defineField({ name: "whatsappButtonLabel", title: "Teks tombol WhatsApp", description: "Teks tombol konsultasi pada section Contact. Gunakan 2-4 kata, contoh: Consult via WhatsApp, lalu klik Publish.", type: "string", fieldset: "contact" }),
    defineField({ name: "email", title: "Email", description: "Muncul sebagai alamat email publik pada section Contact. Jika kosong, website memakai email utama dari Pengaturan Website. Klik Publish setelah mengubahnya.", type: "string", validation: (rule) => rule.email(), fieldset: "contact" }),
