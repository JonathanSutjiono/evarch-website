  ...
  return (
    <section id="stra" className="stra-section section-pad">
      <div className="site-container stra-grid">
        <div className="stra-intro">
          <SectionHeader
            eyebrow="Licensed Architect Verification"
            title={content.heading}
            description={content.description}
          />
          <div className="stra-intro-meta" aria-label="STRA verification details">
            <div>
              <span>Verification method</span>
              <strong>Independent directory check</strong>
            </div>
            <div>
              <span>Directory</span>
              <strong>Dewan Arsitek Indonesia</strong>
            </div>
          </div>
        </div>
