...
export const processStep = defineType({
  ...
  type: "document",
  description: "Setiap dokumen tampil sebagai satu tahapan pada section Process di halaman utama. Ubah, sembunyikan, atau hapus contoh satu per satu, lalu klik Publish agar perubahan tampil di website.",
  fields: [
    defineField({ name: "title", title: "Nama Tahap", description: "Tampil sebagai judul tahapan. Contoh: Consultation atau Design Development. Klik Publish setelah mengubahnya.", type: "string", validation: (rule) => rule.required() }),
    defineField({ name: "description", title: "Penjelasan Tahap", description: "Tampil di bawah nama tahap. Gunakan 1 kalimat yang jelas untuk calon klien, lalu klik Publish.", type: "text", rows: 3 }),
