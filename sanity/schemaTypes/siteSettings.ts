...
export const siteSettings = defineType({
  ...
  fields: [
    ...
    defineField({ name: "logoMark", title: "Logo simbol (opsional)", description: "Digunakan bila versi simbol/logo pendek diperlukan. Unggah file persegi atau mendekati persegi.", type: "image", options: { hotspot: true }, components: { input: ClientImageInput }, fieldset: "identity" }),
    defineField({ name: "favicon", title: "Ikon browser", description: "Ikon kecil pada tab browser. Gunakan gambar persegi, minimal 96 x 96 px.", type: "image", components: { input: ClientImageInput }, fieldset: "identity" }),
    ...
    defineField({ name: "defaultOgImage", title: "Gambar saat link dibagikan", description: "Gambar ini tampil saat link website dibagikan di WhatsApp atau media sosial. Rekomendasi: 1200x630px. Setelah mengganti gambar, klik Publish.", type: "image", options: { hotspot: true }, components: { input: ClientImageInput }, fieldset: "seo" }),
